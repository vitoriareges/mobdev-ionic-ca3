    ...
    var routes = [{
      ...
      children: [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | deathsionic-deathsionic-module */
            [__webpack_require__.e("common"), __webpack_require__.e("deathsionic-deathsionic-module")]).then(__webpack_require__.bind(null,
            /*! ../deathsionic/deathsionic.module */
            "./src/app/pages/deathsionic/deathsionic.module.ts")).then(function (m) {
              return m.DeathsionicPageModule;
            });
          }
        }]
      }]
